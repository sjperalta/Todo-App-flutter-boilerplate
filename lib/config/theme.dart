...
import '/resources/themes/taskflow_theme.dart';
...
final List<BaseThemeConfig<ColorStyles>> appThemes = [
  BaseThemeConfig<ColorStyles>(
    ...
    description: "TaskFlow Light Theme",
    theme: (colors) => TaskFlowThemeConfig.applyTaskFlowTheming(
      lightTheme(colors),
      colors,
    ),
  ...
  BaseThemeConfig<ColorStyles>(
    ...
    description: "TaskFlow Dark Theme", 
    theme: (colors) => TaskFlowThemeConfig.applyTaskFlowTheming(
      darkTheme(colors),
      colors,
    ),
